...
from layers.Embed import PatchEmbedding,PatchEmbeddingFull
...
class Model(nn.Module):
    ...
    def __init__(self, configs):
        ...
        # Embedding
        self.enc_value_embedding = PatchEmbeddingFull(configs.d_model, self.seg_len, self.seg_len, self.pad_in_len - configs.seq_len, 0)
