...
class Model(nn.Module):
    ...
    def forward(self, x_enc, future_rain, x_mark_enc=None, x_dec=None, x_mark_dec=None):
        ...
        enc_out_rain_effect = self.compute_rainfall_influence(enc_out_rain.reshape(batch_size,7, seq_len,-1), adj,self.alpha2, self.beta2)
        ...
        forcontrast=dec_f[:, -self.pred_len:, :].view(batch_size, 56, self.pred_len,-1)
