...
if __name__ == '__main__':
    ...
    parser.add_argument('--lambda_contrast', type=float, required=False, default=False, help='lambda_contrast')
    parser.add_argument('--sharpness', type=float, required=False, default=False, help='lambda_contrast')
